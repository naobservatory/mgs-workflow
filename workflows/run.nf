...
workflow RUN {
    ...
    index_compatibility_ch = Channel.fromPath("${params.ref_dir}/logging/index-min-pipeline-version.txt")
        | map { file -> file.copyTo("${params.base_dir}/work/index-min-pipeline-version.txt") }
    publish:
        // Saved inputs
