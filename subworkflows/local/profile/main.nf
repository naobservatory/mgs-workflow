...
include { SUBSET_READS_PAIRED_TARGET; SUBSET_READS_PAIRED_TARGET as SUBSET_READS_PAIRED_TARGET_GROUP } from "../../../modules/local/subsetReads" addParams(suffix: "fastq")
...
workflow PROFILE {
    ...
    main:
        ...
        if (params.grouping){
            ...
            subset_grouped_ch = SUBSET_READS_PAIRED_TARGET_GROUP(grouped_samples, n_reads)
        ...
        ribo_ch = BBDUK(grouped_ch, ribo_path, params.min_kmer_fraction, params.k)
