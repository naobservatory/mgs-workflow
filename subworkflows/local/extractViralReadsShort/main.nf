...
include { FILTER_PRIMARY_ALIGNMENTS } from "../../../modules/local/filterPrimaryAlignments"
...
workflow EXTRACT_VIRAL_READS_SHORT {
    ...
    main:
        ...
        filtered_ch = FILTER_PRIMARY_ALIGNMENTS(joined_ch.output)
        
        out_labeled_ch = ADD_SAMPLE_COLUMN(filtered_ch.filtered, "sample", "viral_bowtie2")
