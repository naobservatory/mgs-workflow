...
workflow QC {
    ...
    main:
        ...
        basic_out_ch = CONCATENATE_MULTIQC_BASIC(multiqc_basic_ch, "${stage_label}_subset_qc_basic_stats").output
        adapt_out_ch = CONCATENATE_MULTIQC_ADAPT(multiqc_adapt_ch, "${stage_label}_subset_qc_adapter_stats").output
        qbase_out_ch = CONCATENATE_MULTIQC_QBASE(multiqc_qbase_ch, "${stage_label}_subset_qc_quality_base_stats").output
        qseqs_out_ch = CONCATENATE_MULTIQC_QSEQS(multiqc_qseqs_ch, "${stage_label}_subset_qc_quality_sequence_stats").output
        lengths_out_ch = CONCATENATE_MULTIQC_LENGTHS(multiqc_lengths_ch, "${stage_label}_subset_qc_length_stats").output
