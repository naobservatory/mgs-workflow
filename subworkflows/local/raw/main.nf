...
if ( params.read_type == "single_end" ) {
    include { CONCAT_GZIPPED_SINGLE as CONCAT_GZIPPED } from "../../../modules/local/concatGzipped"
    ...
    main:
        ...
        if (params.read_type == "single_end") {
            ...
            if (n_reads_trunc > 0) {
                ...
                // Isn't qc_ch below always overwritten by the qc_ch at the end of the workflow?
                qc_ch = QC(trunc_ch)
            } else {
                out_ch = concat_ch
            }
