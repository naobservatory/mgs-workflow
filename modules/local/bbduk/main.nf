...
process BBDUK {
    ...
    output:
        ...
        tuple val(sample), path("${sample}_bbduk.stats.txt"), emit: log
    shell:
        '''
        # Define input/output
        in1=!{reads[0]}
        in2=!{reads[1]}
        op1=!{sample}_bbduk_pass_1.fastq.gz
        op2=!{sample}_bbduk_pass_2.fastq.gz
        of1=!{sample}_bbduk_fail_1.fastq.gz
        of2=!{sample}_bbduk_fail_2.fastq.gz
