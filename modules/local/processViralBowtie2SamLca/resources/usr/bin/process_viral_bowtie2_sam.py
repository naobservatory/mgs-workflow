...
def get_line_from_single(read_dict: dict[str, str|int|bool],
    ...
    out_dict = {
        ...
        "aligner_classification": "secondary" if read_dict["is_secondary"] else "primary"
    }
    if paired:
...
def get_line_from_pair(dict_1: dict[str, str|int|bool],
    ...
    out_dict = {
        ...
        "aligner_classification": "secondary" if fwd_dict["is_secondary"] else "primary",
        }
