...
process BBMAP {
    ...
    input:
        ...
        path(index_dir)
    output:
        tuple val(sample), path("${sample}_${params.suffix}_bbmap_mapped_{1,2}.fastq.gz"), emit: reads_mapped
        tuple val(sample), path("${sample}_${params.suffix}_bbmap_unmapped_{1,2}.fastq.gz"), emit: reads_unmapped
    ...
    shell:
        ...
        in1=!{reads[0]}
        in2=!{reads[1]}
        ou1=!{sample}_!{params.suffix}_bbmap_unmapped_1.fastq.gz
        ou2=!{sample}_!{params.suffix}_bbmap_unmapped_2.fastq.gz
        om1=!{sample}_!{params.suffix}_bbmap_mapped_1.fastq.gz
        om2=!{sample}_!{params.suffix}_bbmap_mapped_2.fastq.gz
