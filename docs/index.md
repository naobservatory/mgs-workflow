...
- A URL linking to a suitable Kraken2 database for taxonomic profiling (typically the [latest release](https://benlangmead.github.io/aws-indexes/k2) of the `k2_pluspf` database).
...
- A link to a pinned numbered release of [VirusHostDB](https://www.genome.jp/virushostdb), and an up-to-date link to [NCBI Taxonomy](https://ftp.ncbi.nlm.nih.gov/pub/taxonomy/taxdump_archive/).
