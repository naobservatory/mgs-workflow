...
- A link to a pinned numbered release of [VirusHostDB](https://www.genome.jp/virushostdb).
- An up-to-date link to [NCBI Taxonomy](https://ftp.ncbi.nlm.nih.gov/pub/taxonomy/taxdump_archive/).
