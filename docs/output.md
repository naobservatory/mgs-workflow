...
- `kraken_db`: Directory containing Kraken2 reference database (default: the PlusPF build pinned by `params.kraken_db`, refreshed periodically rather than tracking the newest upstream release).
